...
function resolveBackendBase() {
  try {
    const envUrl = "https://vscode-internal-27573-beta.beta01.cloud.kavia.ai:3001" || process.env.REACT_APP_API_BASE_URL;
...
if (process.env.NODE_ENV !== "production") {
  try {
    ...
    console.log(
      ...
      "PREFIX:",
      API_PREFIX,
      ") — Ensure REACT_APP_API_BASE_URL is set to https://vscode-internal-27573-beta.beta01.cloud.kavia.ai:3001"
    );
  } catch {
    // ignore
  }
