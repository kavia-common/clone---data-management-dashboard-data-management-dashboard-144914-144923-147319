...
- npm run dev             # nodemon hot-reload; binds 0.0.0.0:3001; dotenv auto-loaded; memory cap via NODE_OPTIONS
- npm run dev:watch       # same as dev (alias); nodemon with reduced watch overhead and SIGTERM resilience
