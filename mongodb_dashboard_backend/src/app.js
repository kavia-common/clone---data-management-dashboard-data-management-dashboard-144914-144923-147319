...
/**
 * createApp
 * Factory to create and configure a new Express application instance.
 * Returns a fully configured app with middleware, routes, docs, and health endpoints.
 */
function createApp() {
  const app = express();
...
/**
 * PUBLIC_INTERFACE
 * Export factory createApp. Default export is createApp for CommonJS require interoperability.
 */
