...
const analyticsSessionsByTypeRoutes = require('./analytics.sessionsByType.routes');
...
router.use('/analytics', verifyAuth, requireTenant, analyticsSessionsByTypeRoutes);
